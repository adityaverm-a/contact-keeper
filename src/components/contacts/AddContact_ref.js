        ...
        <div className="card-body">
          <form onSubmit={this.onSubmit}>
            ...
            <div className="form-group mx-sm-3">
              ...
              <input type="text" name="phone" className="form-control form-control-lg" placeholder="Enter your Phone Number..." defaultValue={phone} ref={this.phoneInput} />
            </div>
